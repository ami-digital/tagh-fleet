...
<template>
    <transition name="slide-up">
        <section v-if="model" class="side-drawer text-gray-app overflow-auto absolute transform top-0 bottom-0 bg-[#F6F6F6] z-fullscreen w-full">
            <div>
                <div class="flex h-[calc(100vh-60px)]">
                    ...
                    <!-- Sidebar Tabs -->
                    <div class="w-[200px] shadow-md max-sm:w-full max-sm:overflow-x-auto">
                        <q-tabs
                            v-model="tab"
                            vertical
                    ...
                    <!-- Main Content -->
                    <div class="flex-1 p-4 max-sm:p-2">
                                ...
                                <section class="grid grid-cols-2 max-sm:grid-cols-1">
                                    <div class=" max-sm:py-2  ">
                                        <div class="grid grid-cols-6">
                                            <div class="text-[12px] font-medium text-gray-400 flex items-center max-sm:col-span-6  max-sm:mb-2 ">
                                            ...
                                            <div class="col-span-2 flex items-center max-sm:justify-start  lg:justify-end space-x-2 max-sm:col-span-6 max-sm:mb-2">
                                                <q-btn
                                                    label="Edit Route"
                                                    unelevated
                                                    dense
